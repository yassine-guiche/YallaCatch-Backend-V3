...
import { getPartners, createPartner, updatePartner, deletePartner, getNearbyPartners, resetPartnerCredentials, getPartnerCredentials, addPartnerLocation } from '../services/partners';
  ...
  usePartnersUpdates({
    ...
    onRedemptionCreated: (data) => {
      ...
      if (showStatsDialog && statsData) {
        loadPartnerStats(statsData.partnerId);
      }
    },
  });
