 ...
 */
export async function addReward(reward, actor = null) {
  try {
    const backendData = {
      name: reward.name,
 ...
 */
export async function updateReward(id, data, actor = null) {
  try {
    const backendData = {};
 ...
 */
export async function removeReward(id, actor = null) {
  try {
 ...
 */
export async function bulkUpdateRewards(ids, action, actor = null) {
  try {
    const promises = ids.map(id => {
      switch (action) {
        case 'activate':
          return apiService.updateReward(id, { status: 'active' });
        case 'deactivate':
          return apiService.updateReward(id, { status: 'inactive' });
        case 'delete':
