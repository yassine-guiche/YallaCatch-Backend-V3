...
const MapClickHandler = ({ onMapClick, onAreaSelect, onCircleDrawn, mode, selectedArea, setSelectedArea }) => {
    ...
    <div style={{ height, width: '100%', borderRadius: '8px', overflow: 'hidden' }}>
      ...
      >
        ...
        {showPrizes && prizes.length > 0 && (
          ...
          >
            {prizes.map((prize) => {
              if (!prize.zone?.coordinates) return null;
              
              const { lat, lng } = prize.zone.coordinates;
                  ...
                  <Popup>
                    <div className="p-2 min-w-[180px]">
                      ...
                      <div className="space-y-1 text-xs">
                        ...
                        <div className="flex justify-between">
                          <span>Points:</span>
                          <span className="font-medium text-blue-600">{prize.pointsReward}</span>
                        </div>
                        <div className="flex justify-between">
                          <span>Zone:</span>
                          <span className="font-medium">{prize.zone.value}</span>
                        </div>
                      </div>
                    </div>
                  </Popup>
