...
export async function getMyItems() {
  try {
    const res = await apiService.get('/partner/items');
...
export async function createMyItem(data) {
  try {
    const res = await apiService.post('/partner/items', data);
...
export async function updateMyItem(id, data) {
  try {
    const res = await apiService.put(`/partner/items/${id}`, data);
    return res.item || res.data?.item || res.data;
  } catch (error) {
...
export async function deleteMyItem(id) {
  try {
    await apiService.delete(`/partner/items/${id}`);
    return { success: true };
  } catch (error) {
...
export async function getMyAnalytics() {
  try {
    const res = await apiService.get('/partner/analytics');
    return res.data || res;
  } catch (error) {
