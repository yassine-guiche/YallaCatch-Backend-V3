          ...
          <div className="flex items-center justify-between">
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
              ...
              <Card className="relative overflow-hidden">
                ...
                <CardContent>
                  <div className="text-2xl font-bold">{stats?.totals?.todayFulfilled ?? '—'}</div>
                  <p className="text-xs text-muted-foreground mt-1">Validées aujourd'hui</p>
                </CardContent>
              </Card>
              ...
              <Card className="relative overflow-hidden">
                ...
                <CardContent>
                  <div className="text-2xl font-bold">{stats?.totals?.thisWeekRedemptions ?? '—'}</div>
                  <p className="text-xs text-muted-foreground mt-1">Redemptions cette semaine</p>
                </CardContent>
              </Card>
            </div>
